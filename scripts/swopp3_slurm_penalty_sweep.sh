...
# ── SWOPP3 penalty weight sweep (normalized mean penalties) ──
#
# Runs 4 configurations in a SLURM array to find optimal penalty weights.
# All use K=10, σ₀=0.1 (baseline CMA-ES params).
#
# Submit:  sbatch scripts/swopp3_slurm_penalty_sweep.sh
# Monitor: squeue -u $USER

set -euo pipefail

# ── Sweep configurations ──
# Format: "wind_pw wave_pw dist_pw label"
CONFIGS=(
    "50.0  50.0  10.0 w50"
    "100.0 100.0 10.0 w100"
    "200.0 200.0 10.0 w200"
    "500.0 500.0 10.0 w500"
)
...
OUTDIR="output/swopp3_sweep_${LABEL}"
mkdir -p "$OUTDIR"

DT_EVAL=30  # Δt₂ = 30 min evaluation grid

echo "======================================"
echo "SWOPP3 penalty sweep: ${LABEL}"
echo "Date:     $(date)"
echo "Host:     $(hostname)"
...
echo ""
echo "=== Sweep ${LABEL} complete: $(date) ==="
echo ""
